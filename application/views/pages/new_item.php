    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
       <label>Item Name</label>
        <div class="input-group">
              <input class="form-control" type="text" placeholder="Item Name Here">
        </div>   
        <label>Category Name</label>
        <div class="input-group">
              <input class="form-control" type="text" placeholder="Category Name Here">
        </div>   
        <label>Price</label>
        <div class="input-group">
              <input class="form-control" type="text" placeholder="Price Here">
        </div>   
      ...
      <!--<div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> View Category
		  </div>
